...
|--------|------------------|--------------|
| **AKAKPO Godwin** |- Analyse et Conception du Système<br> - Conception et normalisation de la base de données <br> - Développement de l'interface web de gestion des équipements (Module 1 — React)<br> - Développement de l'interface web d'administration BMIShopAdmin (React)<br>- Intégration des interfaces web des modules 1 et 2 au backend et Implémentation du changement de mot de passe au backend <br> - Déploiement des différents modules sur Render (API, Module 1 et 2)| **25%** |
| **GUEZODJE Férréol**   |- Analyse et Conception du Système<br> - Conception et normalisation de la base de données <br>- Développement du backend : API Laravel (Module 2) <br> -API REST, Inscription des clients, gestion des rôles, permissions et accès gestion des produits, panier, commande,  Tableau de bord administrateur, récupération de mot de passe oublié avec OTP<br> | **25%** |
| **LAWANI Hamzath**  |- Analyse et Conception du Système<br> - Conception et normalisation de la base de données <br>  - Développement du backend : API Laravel (Module 1) <br> - API REST, authentification, gestion des rôles, permissions et accès; gestion des equipements, pannes, maitenances; gestion du staff technique; Tableau de bord de gestion .| **25%** | 
| **SAGBO Guillaume** |- Analyse et Conception du Système<br> - Conception et normalisation de la base de données <br>   - Développement de l'interface de l'application mobile cliente BMIShop (Flutter)<br>- Acceuil - Onboarding - Inscription - Connexion -Catalogue produits, panier, commandes, simulation de paiement, gestion du profil utilisateur, Récupération de compte après oublie de mot de passe <br> - Intégration de l'application mobile au backend  | **25%** |
## Objectifs du Projet
